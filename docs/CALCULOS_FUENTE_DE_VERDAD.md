...
- Comparativas con **IPC diciembre–diciembre**; la **Evolución del neto** reexpresa todos los ejercicios a
  **euros del año de la calculadora** (misma moneda fija que el “Neto estimado”); la sección
  **Evolución comparada** (IPC, poder adquisitivo e IRPF) se muestra en **€ constantes 2012** y
  porcentajes vs 2012.
...
| Escenario contrafactual “Deflactar IRPF” | `computePayroll.ts` → `ComputePayrollOptions.irpfMonetaryScaleFactor` |
...
| Resumen superior de “Evolución comparada” | `LandingPage.tsx` → totales anuales reales (`irpfFinal` y `salarioNeto`) en € 2012 del año activo |
